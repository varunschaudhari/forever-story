              ...
              { icon: '🗺️', title: 'Google Maps', desc: 'Open venue location on Google Maps' },
              {
                icon: (
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M12 2C6.48 2 2 6.48 2 12c0 1.54.36 3 .97 4.3L2 22l6.3-.97C9 21.64 10.46 22 12 22c5.52 0 10-4.48 10-10S17.52 2 12 2zm0 18c-1.41 0-2.78-.36-3.97-.97l-.28-.15-3 .46.46-3-.15-.28C3.36 14.78 3 13.41 3 12c0-4.97 4.03-9 9-9s9 4.03 9 9-4.03 9-9 9zm4.64-14.29c-.23-.23-.6-.36-.97-.36-.37 0-.74.13-.97.36l-.48.48c-.23.23-.36.6-.36.97 0 .37.13.74.36.97l.62.62c.23.23.23.6 0 .83l-3.24 3.24c-.23.23-.6.23-.83 0l-.62-.62c-.23-.23-.6-.36-.97-.36-.37 0-.74.13-.97.36l-.48.48c-.23.23-.36.6-.36.97 0 .37.13.74.36.97l2.62 2.62c.23.23.6.36.97.36.37 0 .74-.13.97-.36l.48-.48c.23-.23.6-.36.97-.36.37 0 .74.13.97.36l3.24 3.24c.23.23.23.6 0 .83" fill="white"/>
                  </svg>
                ),
