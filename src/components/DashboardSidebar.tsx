...
export default function DashboardSidebar() {
  ...
  const navItems = [
    ...
    { label: 'My Weddings', icon: '💍', href: '/dashboard/weddings' },
  ...
  return (
    ...
    >
      ...
      <div className={`flex items-center justify-center py-8 px-4 border-b border-outline-variant transition-all duration-300`}>
        <Link
          href="/dashboard"
          className={`font-serif italic text-primary transition-all duration-300 ${
      ...
      <div className="p-3 space-y-3">
        ...
        >
          {session?.user?.image ? (
            ...
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary to-primary-container text-white flex items-center justify-center text-sm font-bold ring-2 ring-primary/20">
